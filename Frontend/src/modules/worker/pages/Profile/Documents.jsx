    ...
    <div className="min-h-screen bg-[#F8FCFC] font-sans text-[#0F172A] ">
      ...
      <main className="px-5 pt-6 max-w-md mx-auto space-y-6">
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2 ml-1 flex items-center gap-1.5">
                <FiFileText className="text-emerald-500" /> Aadhaar Number
              </label>
              <input
                type="text"
                name="aadhaarNumber"
                ...
                maxLength={12}
                className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3.5 text-sm font-bold tracking-widest focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500/30 transition-all text-center"
            ...
            <div>
              ...
              <div 
                className="w-full h-32 bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:bg-emerald-50 hover:border-emerald-200 transition-colors relative overflow-hidden"
              ...
              >
                {previews.front ? (
                  ...
                  <>
                    ...
                    <span className="text-xs font-medium text-gray-500">Tap to upload Front Side</span>
                  </>
                )}
            ...
            <div>
              ...
              >
                {previews.back ? (
                  ...
                  <>
                    <FiUploadCloud className="w-8 h-8 text-gray-300 mb-2" />
                    <span className="text-xs font-medium text-gray-500">Tap to upload Back Side</span>
                  </>
                )}
                {!flutterBridge.isFlutter && (
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-95 shadow-[0_4px_20px_rgba(5,150,105,0.3)] disabled:opacity-70 disabled:active:scale-100"
        >
          {saving ? (
