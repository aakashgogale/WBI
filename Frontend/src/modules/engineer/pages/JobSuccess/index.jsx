  ...
  if (!data) {
    return (
      <div className="min-h-screen bg-[#F8FCFC] flex flex-col items-center justify-center p-6 text-center">
        ...
        <button onClick={() => navigate('/engineer/jobs')} className="px-6 py-3 bg-[#10AFA5] text-white rounded-xl font-medium w-full max-w-xs">
          Back to Jobs
        </button>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#10AFA5]  relative overflow-x-hidden font-sans">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 mt-2">
          <button 
            onClick={() => navigate(`/engineer/job/${id}/report`)}
        ...
        <div className="space-y-3 pt-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              onClick={() => navigate('/engineer/wallet')}
            ...
            <button 
              onClick={() => navigate('/engineer/jobs?status=completed')}
              className="bg-teal-800/30 backdrop-blur-sm text-white font-medium py-3 rounded-xl border border-white/20 hover:bg-teal-800/40 transition"
            >
              Completed Jobs
            </button>
