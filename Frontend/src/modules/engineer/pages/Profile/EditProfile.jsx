...
const EditProfile = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const currentWorker = JSON.parse(localStorage.getItem('engineerData') || '{}');
      localStorage.setItem('engineerData', JSON.stringify({
        ...currentWorker,
        ...payload,
    ...
    <div className="min-h-screen bg-gray-50 ">
      ...
      <main className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <ProfilePhotoUploader 
          ...
          uploadFunction={engineerService.uploadProfilePhoto}
          onUploadSuccess={(newPhotoUrl) => {
            handleInputChange('profilePhoto', newPhotoUrl);
            queryClient.invalidateQueries(['engineerProfile']);
          }}
        />
