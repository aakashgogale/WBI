...
const EngineerJobs = () => {
  ...
  const loadJobs = async (page = 1) => {
    try {
      ...
      const response = await adminEngineerService.getAllJobs(params);
      if (response.success) {
      ...
      toast.error('Failed to load engineer jobs');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search by engineer name or phone..."
              value={searchQuery}
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1 text-sm text-gray-600">
                          <div className="flex items-center gap-2">
                            ...
                            <span>Engineer: <span className="font-medium text-gray-800">{job.engineerId?.name || 'Unassigned'}</span></span>
                          </div>
                          <div className="flex items-center gap-2">
