...
const QualityControlTestEnquiries = () => {
  ...
  const fetchEnquiries = async () => {
    try {
      const res = await api.get('/admin/qctest-enquiries');
      if (res.data.success) {
  ...
  const updateStatus = async (id, newStatus) => {
    try {
      const res = await api.put(`/admin/qctest-enquiries/${id}/status`, { status: newStatus });
      if (res.data.success) {
  ...
  return (
    <AdminLayout>
      <div className="p-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-6">Quality Control Test Enquiries</h1>
            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div className="col-span-2"><p className="text-gray-500">Testing Required For</p><p className="font-medium">{selectedEnquiry.qualityTestingRequiredFor}</p></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div><p className="text-gray-500">Model & Serial</p><p className="font-medium">{selectedEnquiry.equipmentModelSerial || 'N/A'}</p></div>
                  <div><p className="text-gray-500">Number of Units</p><p className="font-medium">{selectedEnquiry.numberOfUnits}</p></div>
                  <div><p className="text-gray-500">Equipment Age</p><p className="font-medium">{selectedEnquiry.equipmentAge}</p></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div><p className="text-gray-500">Need Detailed Report?</p><p className="font-medium">{selectedEnquiry.needDetailedReport}</p></div>
                  <div><p className="text-gray-500">Report Format</p><p className="font-medium">{selectedEnquiry.reportFormat}</p></div>
                  <div><p className="text-gray-500">For Accreditation Submission?</p><p className="font-medium">{selectedEnquiry.isReportForAccreditation}</p></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div><p className="text-gray-500">Interested in QC Contract?</p><p className="font-medium">{selectedEnquiry.interestedInQcContract}</p></div>
...
export default QualityControlTestEnquiries;
