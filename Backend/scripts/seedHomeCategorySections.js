        ...
        cards: [
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135138/WBI/electricity/service/home-wiring.jpg',
            badge: '',
            targetCategoryId: categories['home-wiring-installation']._id
          },
          {
            title: 'Panel Upgrade & Repair',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135139/WBI/electricity/service/electrical-panel-upgrade.jpg',
            badge: '',
            targetCategoryId: categories['panel-upgrade-repair']._id
          },
          {
            title: 'Smart Home Setup',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135140/WBI/electricity/service/smart-home-setup.jpg',
            badge: 'NEW',
        ...
        cards: [
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135151/WBI/appliance/service/ac-repair.jpg',
            badge: '',
            targetCategoryId: categories['ac-service-repair']._id
          },
          {
            title: 'Washing Machine Repair',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135152/WBI/appliance/service/washing-machine-repair-.jpg',
            badge: '',
            targetCategoryId: categories['washing-machine-repair']._id
          },
          {
            title: 'Water Heater Repair',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135154/WBI/appliance/service/water-heater-repair.jpg',
            badge: '',
        ...
        cards: [
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135147/WBI/electricity/service/wiring.jpg',
            badge: '',
          ...
          },
          {
            ...
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135144/WBI/electricity/service/fan.png',
            badge: '',
            targetCategoryId: categories['fan-repair']._id
          },
          {
            title: 'Switch & Socket Installation',
            imageUrl: 'https://res.cloudinary.com/shubhamcloudinary/image/upload/v1766135141/WBI/electricity/service/switch-socket.jpg',
            badge: '',
