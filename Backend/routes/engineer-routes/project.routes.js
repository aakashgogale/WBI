...
const {
  ...
  getMilestoneById
} = require('../../controllers/engineerControllers/engineerProjectController');

// All project routes should be authenticated and require engineer role
router.use(authenticate, isEngineer);

// Get project counts
router.get('/counts', getProjectCounts);

// Get all projects for engineer
